    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="menu">
            <ul class="list">
                ...
                <li class="qqq">
                    <a href="create-slider.php" class="menu-toggle">
                ...
                <li class="qqq">
                    <a href="create-banner.php" class="menu-toggle">
                        <i class="material-icons">chevron_right</i>
                        <span>Banner</span>
                    </a>
                ...
                <li>
                    <a href="view-album-photos.php?id=6" class="menu-toggle">
                        <i class="material-icons">chevron_right</i>
                        <span>Gallery</span>
                    </a>
