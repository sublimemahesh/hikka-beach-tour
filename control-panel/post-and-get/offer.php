...
if (isset($_POST['create'])) {
    ...
    $OFFER->short_description = filter_input(INPUT_POST, 'short_description');
    $OFFER->description = filter_input(INPUT_POST, 'description');
    $OFFER->price = filter_input(INPUT_POST, 'price');
    $OFFER->discount = filter_input(INPUT_POST, 'discount');
