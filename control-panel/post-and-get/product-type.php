...
if (isset($_POST['create'])) {
    ...
    $PRODUCT_TYPE->name = filter_input(INPUT_POST, 'name');
    $PRODUCT_TYPE->short_description = filter_input(INPUT_POST, 'short_description');
    $PRODUCT_TYPE->description = filter_input(INPUT_POST, 'description');
